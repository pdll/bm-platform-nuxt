<template>
  ...
  <panel component="article" itemScope itemType ="http://schema.org/blogPost">
    <userInline slot="header" :user="post.User" />
    ...
    <div class="post-preview">
      <a class="post-preview__title" href="#" @click.prevent="$emit('expand')">{{ post.title }}</a>
      <div>
        <a class="post-preview__body" href="#" @click.prevent="$emit('expand')">{{ post.content }}</a>
      </div>
    </div>
